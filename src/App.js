  ...
  return (
    ...
    <div style={{width: 320, height: 473, left: 360, top: 1429, position: 'absolute'}}>
        ...
        <div style={{width: 300, height: 60, left: 10, top: 403, position: 'absolute'}}>
            <div style={{width: 300, height: 60, left: 0, top: 0, position: 'absolute', background: '#D9C77C', boxShadow: '0px 4px 5px rgba(255, 255, 255, 0.05)', borderRadius: 30}} />
            <div style={{left: 122, top: 17, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 22, fontFamily: 'SF Pro Text', fontWeight: '500', wordWrap: 'break-word'}}>220₽</div>
        </div>
    ...
    <div style={{width: 320, height: 473, left: 26, top: 1429, position: 'absolute'}}>
        ...
        <div style={{width: 300, height: 60, left: 10, top: 403, position: 'absolute'}}>
            <div style={{width: 300, height: 60, left: 0, top: 0, position: 'absolute', background: '#D9C77C', boxShadow: '0px 4px 5px rgba(255, 255, 255, 0.05)', borderRadius: 30}} />
            <div style={{left: 121, top: 17, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 22, fontFamily: 'SF Pro Text', fontWeight: '500', wordWrap: 'break-word'}}>640₽</div>
        </div>
    ...
    <div style={{width: 320, height: 473, left: 360, top: 936, position: 'absolute'}}>
        ...
        <div style={{width: 300, height: 60, left: 10, top: 403, position: 'absolute'}}>
            <div style={{width: 300, height: 60, left: 0, top: 0, position: 'absolute', background: '#D9C77C', boxShadow: '0px 4px 5px rgba(255, 255, 255, 0.05)', borderRadius: 30}} />
            <div style={{left: 121, top: 17, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 22, fontFamily: 'SF Pro Text', fontWeight: '500', wordWrap: 'break-word'}}>380₽</div>
        </div>
    ...
    <div style={{width: 320, height: 473, left: 26, top: 936, position: 'absolute'}}>
        ...
        <div style={{width: 300, height: 60, left: 10, top: 403, position: 'absolute'}}>
            <div style={{width: 300, height: 60, left: 0, top: 0, position: 'absolute', background: '#D9C77C', boxShadow: '0px 4px 5px rgba(255, 255, 255, 0.05)', borderRadius: 30}} />
            <div style={{left: 121, top: 17, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 22, fontFamily: 'SF Pro Text', fontWeight: '500', wordWrap: 'break-word'}}>440₽</div>
        </div>
    ...
    <div style={{width: 320, height: 473, left: 360, top: 443, position: 'absolute'}}>
        ...
        <div style={{width: 300, height: 60, left: 10, top: 403, position: 'absolute'}}>
            <div style={{width: 300, height: 60, left: 0, top: 0, position: 'absolute', background: '#D9C77C', boxShadow: '0px 4px 5px rgba(255, 255, 255, 0.05)', borderRadius: 30}} />
            <div style={{left: 121, top: 17, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 22, fontFamily: 'SF Pro Text', fontWeight: '500', wordWrap: 'break-word'}}>430₽</div>
        </div>
    ...
    <div style={{width: 320, height: 473, left: 26, top: 443, position: 'absolute'}}>
        ...
        <div style={{width: 300, height: 60, left: 10, top: 403, position: 'absolute'}}>
            <div style={{width: 300, height: 60, left: 0, top: 0, position: 'absolute', background: '#D9C77C', boxShadow: '0px 4px 5px rgba(255, 255, 255, 0.05)', borderRadius: 30}} />
            <div style={{left: 122, top: 17, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 22, fontFamily: 'SF Pro Text', fontWeight: '500', wordWrap: 'break-word'}}>230₽</div>
        </div>
    ...
    <div style={{width: 669, left: 26, top: 350, position: 'absolute'}}>
        ...
        <div style={{left: 340, top: 11, position: 'absolute', color: 'rgba(255, 255, 255, 0.50)', fontSize: 26, fontFamily: 'SF Pro Text', fontWeight: '300', wordWrap: 'break-word'}}>Закуски</div>
        <div style={{left: 467, top: 11, position: 'absolute', color: 'rgba(255, 255, 255, 0.50)', fontSize: 26, fontFamily: 'SF Pro Text', fontWeight: '300', wordWrap: 'break-word'}}>Супы</div>
        <div style={{left: 558, top: 11, position: 'absolute', color: 'rgba(255, 255, 255, 0.50)', fontSize: 26, fontFamily: 'SF Pro Text', fontWeight: '300', wordWrap: 'break-word'}}>Десерты</div>
        <div style={{width: 195, height: 53, left: 0, top: 0, position: 'absolute'}}>
            <div style={{width: 195, height: 53, left: 0, top: 0, position: 'absolute', background: 'rgba(255, 255, 255, 0.10)', borderRadius: 20}} />
            <div style={{left: 20, top: 11, position: 'absolute', textAlign: 'center', color: '#D6C27B', fontSize: 26, fontFamily: 'SF Pro Text', fontWeight: '300', wordWrap: 'break-word'}}>Популярное</div>
        </div>
    </div>
    <div style={{width: 59, height: 59, left: 621, top: 235, position: 'absolute'}}>
        <div style={{width: 12.29, height: 19.67, left: 19.67, top: 19.67, position: 'absolute', transform: 'rotate(-90deg)', transformOrigin: '0 0', borderRadius: 44, border: '1.50px #D9C77C solid'}}></div>
        <div style={{width: 0, height: 4.92, left: 36.88, top: 29.50, position: 'absolute', borderRadius: 2, border: '1.50px #D9C77C solid'}}></div>
